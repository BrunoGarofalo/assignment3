...
def calculator():
    ...
    while True:
        ...
        # Now we check what operation the user asked for and call the right method inside the Operations class (addition, subtraction, etc.).
        if operation == "add":
            result = Operations.addition(num1, num2)  # We call the addition method inside the Operations class to add the two numbers.
        elif operation == "subtract":
            result = Operations.subtraction(num1, num2)  # We call the subtraction method inside the Operations class to subtract the two numbers.
        elif operation == "multiply":
            result = Operations.multiplication(num1, num2)  # We call the multiplication function to multiply the two numbers.
        elif operation == "divide":
            try:
                result = Operations.division(num1, num2)  # We call the division method inside the Operations class to divide the two numbers.
